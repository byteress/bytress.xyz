...
function MyApp({ Component, pageProps, router }: AppProps) {
    ...
    return (
        <>
            <Head>
                <meta charSet="utf-8" />
                <title>Cyanne Justin Vega</title>
                <link rel="icon" href="/favicon.ico" />
                <meta name="viewport" content="width=device-width,initial-scale=1" />
                <meta name="theme-color" content="#000000" />
                <meta
                    name="keywords"
                    content="bitress, Cyanne Justin Vega, byteress, Cyanne, web developer, github, typescript"
                />
                <meta name="description" content="Cyanne Justin Vega - bitress" />
